...
export class default1671116854756 implements MigrationInterface {
    name = 'default1671116854756'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "profiles" DROP CONSTRAINT "FK_9e432b7df0d182f8d292902d1a2"`);
        await queryRunner.query(`ALTER TABLE "profiles" RENAME COLUMN "user_id" TO "userId"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "profiles" RENAME COLUMN "userId" TO "user_id"`);
